...
Ce modèle Pytohn te laisse commencer rapidement avec un exemple de travail simple. Si c'est ta première contribution il serait bon jeter un oeil sur le document [Getting Started](https://tech.io/doc/getting-started-create-playground) document.
